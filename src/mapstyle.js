mapstyle = {
    ...
    "sources": {
        "basemap": {
            "tiles": [
                "https://maps.dev.qwant.ninja/maps/tiles/ozbasemap/{z}/{x}/{y}.pbf"
            ],
            "name": "OpenMapTiles",
            "format": "pbf",
            "basename": "v3.7.mbtiles",
            "id": "openmaptiles",
            "attribution": "<a href=\"https://about.qwant.com/fr/legal/cgu/qwant-maps/\" target=\"_blank\">Qwant Maps</a> <a href=\"http://www.openmaptiles.org/\" target=\"_blank\">&copy;&nbsp;OpenMapTiles</a> <a href=\"http://www.openstreetmap.org/about/\" target=\"_blank\">&copy;&nbsp;OpenStreetMap contributors</a>",
            "center": [
                -12.2168,
                28.6135,
                4
        ...
        "poi": {
            "tiles": [
                "https://maps.dev.qwant.ninja/maps/tiles/ozpoi/{z}/{x}/{y}.pbf"
            ],
            "name": "OpenMapTiles",
            "format": "pbf",
            "basename": "v3.7.mbtiles",
            ...
            "description": "Une adaptation des tuiles OpenMapTiles pour Qwant Maps - juste les POIs",
            "maxzoom": 14,
            "minzoom": 0,
            "pixel_scale": "256",
            "maskLevel": "8",
    ...
    "sprite": "http://localhost:3000/mapstyle/sprite",
    "glyphs": "http://localhost:3000/mapstyle/font/{fontstack}/{range}.pbf",
    "layers": [
        {
            "id": "background",
            "type": "background",
